                            ...
                            <div className='relative px-8 pt-14 pb-10 text-center'>
                                ...
                                {window.location.hostname === 'localhost' && (
                                    <motion.button
                                        ...
                                        className="group relative w-full h-10 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 font-semibold shadow-xl overflow-hidden mt-3 cursor-pointer transition-colors duration-200"
                                    >
